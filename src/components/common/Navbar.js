...
const Navbar = () => {
    const menuItems = <>
        ...
        <li className='text-lg font-semibold'><Link to='/cars'>Cars</Link></li>
    ...
    return (
        <div class="navbar bg-base-100 px-4 lg:px-20">
            <div class="navbar-start">
                ...
                <Link class="btn btn-ghost normal-case text-3xl" to="/">Cmart</Link>
            </div>
